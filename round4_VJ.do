...
clear
import delimited E:\artigo3\dados_logit_VJ_final.csv, encoding(utf8)
set matsize 10000
...
logit resultado i.ano vaza_jato i.comarca_bin i.assunto_bin corrupcao_vaza_jato_filled, rob
...
logit resultado i.ano vaza_jato i.tema_bin i.comarca_bin corrupcao_vaza_jato_filled, rob
...
logit resultado i.ano vaza_jato i.tema_bin i.assunto_bin corrupcao_vaza_jato_filled, rob
margins, dydx(i.tema_bin vaza_jato corrupcao_vaza_jato_filled) post
...
logit resultado i.ano vaza_jato i.tema_bin i.comarca_bin i.assunto_bin corrupcao_vaza_jato_filled, rob
margins, dydx(i.tema_bin vaza_jato corrupcao_vaza_jato_filled) post
...
clear
import delimited E:\artigo3\dados_logit_corrupcao_VJ_final.csv, encoding(utf8)
set matsize 10000
...
logit resultado i.ano vaza_jato i.comarca_bin i.assunto_bin corrupcao_vaza_jato_filled, rob
margins, dydx(vaza_jato corrupcao_vaza_jato_filled) post
outreg2 using "E:\artigo3\logit_marg_corrupcao_VJ_2.xls", replace ctitle(Logit_corrupcao_Marg) keep(i.tema_bin vaza_jato corrupcao_vaza_jato_filled) label addtext(Type of Crime FE, NO, Subject FE, YES, Judicial District FE, YES , Year Trend, YES)

logit resultado i.ano vaza_jato i.tema_bin i.comarca_bin corrupcao_vaza_jato_filled, rob
margins, dydx(i.tema_bin vaza_jato corrupcao_vaza_jato_filled) post
outreg2 using "E:\artigo3\logit_marg_corrupcao_VJ_2.xls", append ctitle(Logit_corrupcao_Marg) keep(i.tema_bin vaza_jato corrupcao_vaza_jato_filled) label addtext(Type of Crime FE, YES, Subject FE, NO, Judicial District FE, YES , Year Trend, YES)

logit resultado i.ano vaza_jato i.tema_bin i.assunto_bin corrupcao_vaza_jato_filled, rob
margins, dydx(i.tema_bin vaza_jato corrupcao_vaza_jato_filled) post
outreg2 using "E:\artigo3\logit_marg_corrupcao_VJ_2.xls", append ctitle(Logit_corrupcao_Marg) keep(i.tema_bin vaza_jato corrupcao_vaza_jato_filled) label addtext(Type of Crime FE, YES, Subject FE, YES, Judicial District FE, NO , Year Trend, YES)

logit resultado i.ano vaza_jato i.tema_bin i.comarca_bin i.assunto_bin corrupcao_vaza_jato_filled, rob
margins, dydx(i.tema_bin vaza_jato corrupcao_vaza_jato_filled) post
outreg2 using "E:\artigo3\logit_marg_corrupcao_VJ_2.xls", append ctitle(Logit_corrupcao_Marg) keep(i.tema_bin vaza_jato corrupcao_vaza_jato_filled) label addtext(Type of Crime FE, YES, Subject FE, YES, Judicial District FE, YES , Year Trend, NO)

logit resultado i.ano vaza_jato i.tema_bin i.comarca_bin i.assunto_bin corrupcao_vaza_jato_filled, rob
margins, dydx(i.tema_bin vaza_jato corrupcao_vaza_jato_filled) post
outreg2 using "E:\artigo3\logit_marg_corrupcao_VJ_2.xls", append ctitle(Logit_corrupcao_Marg) keep(i.tema_bin vaza_jato corrupcao_vaza_jato_filled) label addtext(Type of Crime FE, YES, Subject FE, YES, Judicial District FE, YES , Year Trend, YES)

*------------------- regressao Logit Resultados (acordo = Condenado) -------------------* 

clear
import delimited E:\artigo3\dados_logit_trafico_VJ_final.csv, encoding(utf8)
set matsize 10000
...
clear
import delimited E:\artigo3\dados_logit_crime_VJ_final.csv, encoding(utf8)
set matsize 10000
...
logit resultado ano vaza_jato i.comarca_bin i.assunto_bin corrupcao_vaza_jato_filled, rob
...
logit resultado ano vaza_jato i.tema_bin i.comarca_bin corrupcao_vaza_jato_filled, rob
...
logit resultado ano vaza_jato i.tema_bin i.assunto_bin corrupcao_vaza_jato_filled, rob
margins, dydx(ano i.tema_bin vaza_jato corrupcao_vaza_jato_filled) post
...
logit resultado ano vaza_jato i.tema_bin i.comarca_bin i.assunto_bin corrupcao_vaza_jato_filled, rob
margins, dydx(ano i.tema_bin vaza_jato corrupcao_vaza_jato_filled) post
...
logit resultado ano vaza_jato i.comarca_bin i.assunto_bin corrupcao_vaza_jato_filled, rob
margins, dydx(ano vaza_jato corrupcao_vaza_jato_filled) post
outreg2 using "E:\artigo3\logit_marg_corrupcao_VJ.xls", replace ctitle(Logit_corrupcao_Marg) keep(ano i.tema_bin vaza_jato corrupcao_vaza_jato_filled) label addtext(Type of Crime FE, NO, Subject FE, YES, Judicial District FE, YES , Year Trend, YES)

logit resultado ano vaza_jato i.tema_bin i.comarca_bin corrupcao_vaza_jato_filled, rob
margins, dydx(ano i.tema_bin vaza_jato corrupcao_vaza_jato_filled) post
outreg2 using "E:\artigo3\logit_marg_corrupcao_VJ.xls", append ctitle(Logit_corrupcao_Marg) keep(ano i.tema_bin vaza_jato corrupcao_vaza_jato_filled) label addtext(Type of Crime FE, YES, Subject FE, NO, Judicial District FE, YES , Year Trend, YES)

logit resultado ano vaza_jato i.tema_bin i.assunto_bin corrupcao_vaza_jato_filled, rob
margins, dydx(ano i.tema_bin vaza_jato corrupcao_vaza_jato_filled) post
outreg2 using "E:\artigo3\logit_marg_corrupcao_VJ.xls", append ctitle(Logit_corrupcao_Marg) keep(ano i.tema_bin vaza_jato corrupcao_vaza_jato_filled) label addtext(Type of Crime FE, YES, Subject FE, YES, Judicial District FE, NO , Year Trend, YES)

logit resultado ano vaza_jato i.tema_bin i.comarca_bin i.assunto_bin corrupcao_vaza_jato_filled, rob
margins, dydx(ano i.tema_bin vaza_jato corrupcao_vaza_jato_filled) post
outreg2 using "E:\artigo3\logit_marg_corrupcao_VJ.xls", append ctitle(Logit_corrupcao_Marg) keep(ano i.tema_bin vaza_jato corrupcao_vaza_jato_filled) label addtext(Type of Crime FE, YES, Subject FE, YES, Judicial District FE, YES , Year Trend, NO)

logit resultado ano vaza_jato i.tema_bin i.comarca_bin i.assunto_bin corrupcao_vaza_jato_filled, rob
margins, dydx(ano i.tema_bin vaza_jato corrupcao_vaza_jato_filled) post
outreg2 using "E:\artigo3\logit_marg_corrupcao_VJ.xls", append ctitle(Logit_corrupcao_Marg) keep(ano i.tema_bin vaza_jato corrupcao_vaza_jato_filled) label addtext(Type of Crime FE, YES, Subject FE, YES, Judicial District FE, YES , Year Trend, YES)
...
logit resultado i.ano i.comarca_bin i.assunto_bin vaza_jato_1 vaza_jato_2  vaza_jato_1_corrupcao vaza_jato_2_corrupcao, rob
...
logit resultado i.ano i.tema_bin i.comarca_bin vaza_jato_1 vaza_jato_2  vaza_jato_1_corrupcao vaza_jato_2_corrupcao, rob
...
logit resultado i.ano i.tema_bin i.assunto_bin vaza_jato_1 vaza_jato_2  vaza_jato_1_corrupcao vaza_jato_2_corrupcao, rob
margins, dydx(i.tema_bin vaza_jato_1 vaza_jato_2  vaza_jato_1_corrupcao vaza_jato_2_corrupcao) post
...
logit resultado i.ano i.tema_bin i.comarca_bin i.assunto_bin vaza_jato_1 vaza_jato_2  vaza_jato_1_corrupcao vaza_jato_2_corrupcao, rob
margins, dydx(i.tema_bin vaza_jato_1 vaza_jato_2  vaza_jato_1_corrupcao vaza_jato_2_corrupcao) post
...
logit resultado i.ano i.comarca_bin i.assunto_bin vaza_jato_1 vaza_jato_2  vaza_jato_1_corrupcao vaza_jato_2_corrupcao, rob
margins, dydx(vaza_jato_1 vaza_jato_2  vaza_jato_1_corrupcao vaza_jato_2_corrupcao) post
outreg2 using "E:\artigo3\logit_marg_corrupcao_VJ_2.xls", replace ctitle(Logit_corrupcao_Marg) keep(i.tema_bin vaza_jato_1 vaza_jato_2  vaza_jato_1_corrupcao vaza_jato_2_corrupcao) label addtext(Type of Crime FE, NO, Subject FE, YES, Judicial District FE, YES , Year Trend, YES)

logit resultado i.ano i.tema_bin i.comarca_bin vaza_jato_1 vaza_jato_2  vaza_jato_1_corrupcao vaza_jato_2_corrupcao, rob
margins, dydx(i.tema_bin vaza_jato_1 vaza_jato_2  vaza_jato_1_corrupcao vaza_jato_2_corrupcao) post
outreg2 using "E:\artigo3\logit_marg_corrupcao_VJ_2.xls", append ctitle(Logit_corrupcao_Marg) keep(i.tema_bin vaza_jato_1 vaza_jato_2  vaza_jato_1_corrupcao vaza_jato_2_corrupcao) label addtext(Type of Crime FE, YES, Subject FE, NO, Judicial District FE, YES , Year Trend, YES)

logit resultado i.ano i.tema_bin i.assunto_bin vaza_jato_1 vaza_jato_2  vaza_jato_1_corrupcao vaza_jato_2_corrupcao, rob
margins, dydx(i.tema_bin vaza_jato_1 vaza_jato_2  vaza_jato_1_corrupcao vaza_jato_2_corrupcao) post
outreg2 using "E:\artigo3\logit_marg_corrupcao_VJ_2.xls", append ctitle(Logit_corrupcao_Marg) keep(i.tema_bin vaza_jato_1 vaza_jato_2  vaza_jato_1_corrupcao vaza_jato_2_corrupcao) label addtext(Type of Crime FE, YES, Subject FE, YES, Judicial District FE, NO , Year Trend, YES)

logit resultado i.ano i.tema_bin i.comarca_bin i.assunto_bin vaza_jato_1 vaza_jato_2  vaza_jato_1_corrupcao vaza_jato_2_corrupcao, rob
margins, dydx(i.tema_bin vaza_jato_1 vaza_jato_2  vaza_jato_1_corrupcao vaza_jato_2_corrupcao) post
outreg2 using "E:\artigo3\logit_marg_corrupcao_VJ_2.xls", append ctitle(Logit_corrupcao_Marg) keep(i.tema_bin vaza_jato_1 vaza_jato_2  vaza_jato_1_corrupcao vaza_jato_2_corrupcao) label addtext(Type of Crime FE, YES, Subject FE, YES, Judicial District FE, YES , Year Trend, NO)

logit resultado i.ano i.tema_bin i.comarca_bin i.assunto_bin vaza_jato_1 vaza_jato_2  vaza_jato_1_corrupcao vaza_jato_2_corrupcao, rob
margins, dydx(i.tema_bin vaza_jato_1 vaza_jato_2  vaza_jato_1_corrupcao vaza_jato_2_corrupcao) post
outreg2 using "E:\artigo3\logit_marg_corrupcao_VJ_2.xls", append ctitle(Logit_corrupcao_Marg) keep(i.tema_bin vaza_jato_1 vaza_jato_2  vaza_jato_1_corrupcao vaza_jato_2_corrupcao) label addtext(Type of Crime FE, YES, Subject FE, YES, Judicial District FE, YES , Year Trend, YES)
...
logit resultado ano i.comarca_bin i.assunto_bin vaza_jato_1 vaza_jato_2  vaza_jato_1_corrupcao vaza_jato_2_corrupcao, rob
...
logit resultado ano i.tema_bin i.comarca_bin vaza_jato_1 vaza_jato_2  vaza_jato_1_corrupcao vaza_jato_2_corrupcao, rob
...
logit resultado ano i.tema_bin i.assunto_bin vaza_jato_1 vaza_jato_2  vaza_jato_1_corrupcao vaza_jato_2_corrupcao, rob
margins, dydx(ano i.tema_bin vaza_jato_1 vaza_jato_2  vaza_jato_1_corrupcao vaza_jato_2_corrupcao) post
...
logit resultado ano i.tema_bin i.comarca_bin i.assunto_bin vaza_jato_1 vaza_jato_2  vaza_jato_1_corrupcao vaza_jato_2_corrupcao, rob
margins, dydx(ano i.tema_bin vaza_jato_1 vaza_jato_2  vaza_jato_1_corrupcao vaza_jato_2_corrupcao) post
...
logit resultado ano i.comarca_bin i.assunto_bin vaza_jato_1 vaza_jato_2  vaza_jato_1_corrupcao vaza_jato_2_corrupcao, rob
margins, dydx(ano vaza_jato_1 vaza_jato_2  vaza_jato_1_corrupcao vaza_jato_2_corrupcao) post
outreg2 using "E:\artigo3\logit_marg_corrupcao_VJ.xls", replace ctitle(Logit_corrupcao_Marg) keep(ano i.tema_bin vaza_jato_1 vaza_jato_2  vaza_jato_1_corrupcao vaza_jato_2_corrupcao) label addtext(Type of Crime FE, NO, Subject FE, YES, Judicial District FE, YES , Year Trend, YES)

logit resultado ano i.tema_bin i.comarca_bin vaza_jato_1 vaza_jato_2  vaza_jato_1_corrupcao vaza_jato_2_corrupcao, rob
margins, dydx(ano i.tema_bin vaza_jato_1 vaza_jato_2  vaza_jato_1_corrupcao vaza_jato_2_corrupcao) post
outreg2 using "E:\artigo3\logit_marg_corrupcao_VJ.xls", append ctitle(Logit_corrupcao_Marg) keep(ano i.tema_bin vaza_jato_1 vaza_jato_2  vaza_jato_1_corrupcao vaza_jato_2_corrupcao) label addtext(Type of Crime FE, YES, Subject FE, NO, Judicial District FE, YES , Year Trend, YES)

logit resultado ano i.tema_bin i.assunto_bin vaza_jato_1 vaza_jato_2  vaza_jato_1_corrupcao vaza_jato_2_corrupcao, rob
margins, dydx(ano i.tema_bin vaza_jato_1 vaza_jato_2  vaza_jato_1_corrupcao vaza_jato_2_corrupcao) post
outreg2 using "E:\artigo3\logit_marg_corrupcao_VJ.xls", append ctitle(Logit_corrupcao_Marg) keep(ano i.tema_bin vaza_jato_1 vaza_jato_2  vaza_jato_1_corrupcao vaza_jato_2_corrupcao) label addtext(Type of Crime FE, YES, Subject FE, YES, Judicial District FE, NO , Year Trend, YES)

logit resultado ano i.tema_bin i.comarca_bin i.assunto_bin vaza_jato_1 vaza_jato_2  vaza_jato_1_corrupcao vaza_jato_2_corrupcao, rob
margins, dydx(ano i.tema_bin vaza_jato_1 vaza_jato_2  vaza_jato_1_corrupcao vaza_jato_2_corrupcao) post
outreg2 using "E:\artigo3\logit_marg_corrupcao_VJ.xls", append ctitle(Logit_corrupcao_Marg) keep(ano i.tema_bin vaza_jato_1 vaza_jato_2  vaza_jato_1_corrupcao vaza_jato_2_corrupcao) label addtext(Type of Crime FE, YES, Subject FE, YES, Judicial District FE, YES , Year Trend, NO)

logit resultado ano i.tema_bin i.comarca_bin i.assunto_bin vaza_jato_1 vaza_jato_2  vaza_jato_1_corrupcao vaza_jato_2_corrupcao, rob
margins, dydx(ano i.tema_bin vaza_jato_1 vaza_jato_2  vaza_jato_1_corrupcao vaza_jato_2_corrupcao) post
outreg2 using "E:\artigo3\logit_marg_corrupcao_VJ.xls", append ctitle(Logit_corrupcao_Marg) keep(ano i.tema_bin vaza_jato_1 vaza_jato_2  vaza_jato_1_corrupcao vaza_jato_2_corrupcao) label addtext(Type of Crime FE, YES, Subject FE, YES, Judicial District FE, YES , Year Trend, YES)
